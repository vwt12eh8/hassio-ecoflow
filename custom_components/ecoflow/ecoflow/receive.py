...
def parse_ems_delta(d: bytes):
    return _parse_dict(d, [
        ...
        ("_chg_cmd", 1, _to_int),
        ("_dsg_cmd", 1, _to_int),
        ("battery_main_voltage", 4, _to_int),
        ...
        ("battery_main_voltage_min", 4, _to_int),
        ("battery_main_voltage_max", 4, _to_int),
...
def parse_ems_river(d: bytes):
    return _parse_dict(d, [
        ...
        ("battery_level_max", 1, _to_int),
        ("battery_main_voltage_max", 2, _to_int),
        ("battery_main_voltage_min", 2, _to_int),
...
def parse_inverter_delta(d: bytes):
    return _parse_dict(d, [
        ...
        ("ac_out_voltage_config", 4, _to_int),
